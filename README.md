...
- **รหัสนักเรียนอัตโนมัติ** — เว้นว่างช่องรหัสตอนเพิ่มนักเรียน ระบบจะรันเลขให้ต่อเนื่อง กำหนดเลขเริ่มต้นได้
- **เลื่อนชั้นเรียน** — ย้ายนักเรียนทั้งห้องขึ้นชั้นใหม่เมื่อเปลี่ยนปีการศึกษา หรือนำออกเมื่อจบการศึกษา
- **เวลาเรียน** — กำหนดเวลาเริ่ม-จบของคาบ 1-8 แสดงในตารางและไฟล์ที่ส่งออก
